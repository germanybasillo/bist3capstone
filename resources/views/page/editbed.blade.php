 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Edit New Bed</h1>
          </div>
          <div class="col-sm-6">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-success">
              <!-- form start -->
              <form role="form" id="quickForm" action="{{route('beds.edit',$bed->id)}}" method="POST">
                @csrf
                @method('PUT')
                <div class="card-body">
                  <div class="row">
                  ...
                  <div class="form-group">
                    <label>Room No.</label>
                    <input type="text" name="room_no" class="form-control" placeholder="ex. RM-0001" value="{{$bed->room_no}}">
                  </div></div>
                  <div class="col-md-8 offset-md-2">
                  <div class="form-group">
                    <label>Bed No.</label>
                  ...
                  <div class="col-md-8 offset-md-2">
                    ...
                    <div class="form-group">
                      <select class="form-control" name="bed_status" value="{{$bed->bed_status}}">
